...
Βάσει των γραφημάτων παρατηρούμε ότι το benchmark specmcf έχει τη χειρότερη απόδοση (πολύ κακή) όσον αφορά τον ρυθμό αστοχίας της L1 i cache, όμως δεν είναι το benchmark με τη χειρότερη απόδοση (αντίθετα, επιτυγχάνει τον καλύτερο CPI). Το χειρότερο benchmark είναι το specsjeng, το οποίο έχει τον μεγαλύτερο ρυθμό αστοχίας της L2 cache. Αυτό συμβαίνει επειδή η L2 cache είναι πολύ πιο αργή από την L1 και η έλλειψη απόδοσης σε αυτήν μπορεί να καθιστά την CPU πολύ αργή. Μπορούμε επίσης να δούμε ότι η MinorCPU κάνει εξαιρετική δουλειά χειριζόμενη το benchmark specbzip, διατηρώντας ισορροπημένη απόδοση στη μνήμη.
